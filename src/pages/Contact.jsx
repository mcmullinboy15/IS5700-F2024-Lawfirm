        ...
        <div class="clearfix">
          <div class="sidebar">
            <div>
              ...
              <ul class="contact">
                ...
                <li>
                  <p class="phone">Phone: (+20) 000 222 999</p>
                </li>
                <li>
                  <p class="fax">Fax: (+20) 000 222 988</p>
                </li>
                <li>
                  <p class="mail">Email: info@freewebsitetemplates.com</p>
                </li>
              </ul>
            </div>
          </div>
          <div class="main">
            ...
            <p>
              ...
              us.If you're having problems editing this website template, then
